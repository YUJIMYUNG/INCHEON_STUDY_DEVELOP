...
public class BoardDao {
    ...
    public void fileSave(){ // 게시물 등록을 성공했을 때 지정한 함수 사용/호출
        ...
        for(int i = 0; i < boardDB.size(); i++){ // 리스트 객체 내 인덱스부터 마지막 인덱스까지 반복
    ...
    public void fileLoad(){
        try{
            // 1. 파일 입력 객체 생성
            FileInputStream fileInputStream = new FileInputStream("./src/day25/boardService9mvc/data.txt");
            ...
            // 4. 읽어온 바이트 배열을 문자열(String)으로 변호나
